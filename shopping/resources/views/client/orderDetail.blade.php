                ...
                <div class="blog-wrapper">
                    <div class="row mb-n6">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <form>
                                <h3 margin-bottom: 20px;>Chi tiết đơn hàng của bạn</h3>
                                <div class="order_table table-responsive">
                                    <table>
                                        ...
                                        @foreach($detail_orders as $item)
                                            <tr>
                                                <td  style="text-align: center!important;"> <img style="width: 50px;margin-left: 10px;" src="/images/{{$item->img_pro}}" alt=""></td>
                                                <td  style="text-align: center!important;">{{$item->name_pro}}</td>
                                                <td  style="text-align: center!important;">{{$item->quantity}} </td>
                                                <td style="text-align: center!important; color: brown;">{{ number_format($item->sumPrice_pro, 0)}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
