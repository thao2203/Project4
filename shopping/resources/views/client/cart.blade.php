                        ...
                        <div class="coupon_code left" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="coupon_inner">
                                ...
                                <form action="{{url('/check-coupon')}}" method="POST">
                                    @csrf
                                    <input name="counpon" class="mb-2" placeholder="Nhập mã giảm giá" type="text">
                                    <button type="submit" name="check_coupon" class="btn btn-md btn-golden check_coupon">Tính mã giảm giá</button>
                                </form>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                ...
                                <div class="cart_subtotal ">
                                    <p>Giá trị vận chuyển</p>
                                    <p class="cart_amount"><span>Giá cố định:</span> 50,000 VNĐ</p>
                                </div>
