                                    ...
                                    <tbody>
                                        ...
                                        @foreach(Session::get('cart') as $item)
                                            <tr>
                                                ...
                                                <td class="product_thumb"><a href="product-details-default.html"><img src="/images/{{$item['product_img']}}" alt=""></a></td>
                                                <td class="product_name"><a href="product-details-default.html">{{$item['product_name']}}</a></td>
                                                <td class="product-price">{{number_format($item['product_price'], 0)}}</td>
                                                <td class="product_quantity"><label>Số lượng</label> <input min="1" max="100" value="{{$item['product_count']}}" type="number"></td>
                                                <td class="product_total">{{ number_format((integer)$item['product_price']*(integer)$item['product_count'], 0)}}</td>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="coupon_code left"  data-aos="fade-up"  data-aos-delay="200">
                            ...
                            <div class="coupon_inner">
                                ...
                                <button type="submit" class="btn btn-md btn-golden">Mã giảm giá</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="coupon_code right"  data-aos="fade-up"  data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                <div class="cart_subtotal">
                                    <p>Tổng phụ</p>
                                    <p class="cart_amount">620,000 vnđ</p>
                                </div>
                                <div class="cart_subtotal ">
                                    <p>Phí vận chuyển</p>
                                    <p class="cart_amount"><span>Giá cố định:</span> 20,000 vnđ</p>
                                </div>
                                <a href="#">Tính toán vận chuyển</a>

                                <div class="cart_subtotal">
                                    <p>Tổng</p>
                                    <p class="cart_amount">640,000 vnđ</p>
                                </div>
                                <div class="checkout_btn">
                                    <a href="#" class="btn btn-md btn-golden">Tiến hành kiểm tra</a>
                                </div>
                            </div>
                        </div>
                    </div>
